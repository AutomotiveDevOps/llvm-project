; RUN: llc -mtriple=powerpc-none-eabivle -mcpu=e200z7 -mvle -O2 < %s | FileCheck %s

; Test e200z7 scheduler latency verification.
; Verify instruction latencies match manual specifications for e200z7.
; Reference: E200Z7CRM, Chapter 4
