; RUN: llc -mtriple=powerpc-none-eabivle -mcpu=e200z6 -mvle -O2 < %s | FileCheck %s

; Test e200z6 scheduler latency verification.
; Verify instruction latencies match manual specifications for e200z6.
; Reference: e200z6RM, Chapter 4
