; RUN: llc -mtriple=powerpc-none-eabivle -mcpu=e200z3 -mvle -O2 < %s | FileCheck %s

; Test e200z3 scheduler latency verification.
; Verify instruction latencies match manual specifications for e200z3.
; Reference: e200z3RM, Chapter 4
