...
set(LLVM_BUILD_BINARY_DIR "/projects/vle/llvm-project/build")
set(LLVM_BUILD_LIBRARY_DIR "/projects/vle/llvm-project/build/./lib")
set(LLVM_BUILD_MAIN_INCLUDE_DIR "/projects/vle/llvm-project/llvm/include")
set(LLVM_BUILD_MAIN_SRC_DIR "/projects/vle/llvm-project/llvm")
...
set(LLVM_AVAILABLE_LIBS LLVMDemangle;LLVMSupportLSP;LLVMSupport;LLVMTableGen;LLVMTableGenBasic;LLVMTableGenCommon;LLVMCore;LLVMFuzzerCLI;LLVMFuzzMutate;LLVMFileCheck;LLVMInterfaceStub;LLVMIRPrinter;LLVMIRReader;LLVMCAS;LLVMCGData;LLVMCodeGen;LLVMSelectionDAG;LLVMAsmPrinter;LLVMMIRParser;LLVMGlobalISel;LLVMCodeGenTypes;LLVMBinaryFormat;LLVMBitReader;LLVMBitWriter;LLVMBitstreamReader;LLVMDWARFLinker;LLVMDWARFLinkerClassic;LLVMDWARFLinkerParallel;LLVMExtensions;LLVMFrontendAtomic;LLVMFrontendDirective;LLVMFrontendDriver;LLVMFrontendHLSL;LLVMFrontendOpenACC;LLVMFrontendOpenMP;LLVMFrontendOffloading;LLVMTransformUtils;LLVMInstrumentation;LLVMAggressiveInstCombine;LLVMInstCombine;LLVMScalarOpts;LLVMipo;LLVMVectorize;LLVMObjCARCOpts;LLVMCoroutines;LLVMCFGuard;LLVMHipStdPar;LLVMLinker;LLVMAnalysis;LLVMLTO;LLVMMC;LLVMMCParser;LLVMMCDisassembler;LLVMMCA;LLVMObjCopy;LLVMObject;LLVMObjectYAML;LLVMOption;LLVMRemarks;LLVMDebuginfod;LLVMDebugInfoDWARFLowLevel;LLVMDebugInfoDWARF;LLVMDebugInfoGSYM;LLVMDebugInfoLogicalView;LLVMDebugInfoMSF;LLVMDebugInfoCodeView;LLVMDebugInfoPDB;LLVMSymbolize;LLVMDebugInfoBTF;LLVMDWARFCFIChecker;LLVMDWP;LLVMExecutionEngine;LLVMInterpreter;LLVMJITLink;LLVMMCJIT;LLVMOrcJIT;LLVMOrcDebugging;LLVMOrcShared;LLVMOrcTargetProcess;LLVMRuntimeDyld;LLVMTarget;LLVMPowerPCCodeGen;LLVMPowerPCAsmParser;LLVMPowerPCDisassembler;LLVMPowerPCDesc;LLVMPowerPCInfo;LLVMSandboxIR;LLVMAsmParser;LLVMLineEditor;LLVMProfileData;LLVMCoverage;LLVMPasses;LLVMTargetParser;LLVMTextAPI;LLVMTextAPIBinaryReader;LLVMTelemetry;LLVMDlltoolDriver;LLVMLibDriver;LLVMXRay;LLVMWindowsDriver;LLVMWindowsManifest;LTO;LLVMCFIVerify;LLVMDiff;LLVMExegesisPowerPC;LLVMExegesis;LLVMOptDriver;Remarks)
...
set(LLVM_INCLUDE_DIRS "/projects/vle/llvm-project/llvm/include;/projects/vle/llvm-project/build/include")
set(LLVM_LIBRARY_DIRS "/projects/vle/llvm-project/build/./lib")
...
set(LLVM_MAIN_INCLUDE_DIR "/projects/vle/llvm-project/llvm/include")
set(LLVM_LIBRARY_DIR "/projects/vle/llvm-project/build/./lib")

# This is a secondary one for generated files
set(LLVM_INCLUDE_DIR "/projects/vle/llvm-project/build/include")

set(LLVM_DEFINITIONS "-D_GNU_SOURCE -D_GLIBCXX_USE_CXX11_ABI=1 -D__STDC_CONSTANT_MACROS -D__STDC_FORMAT_MACROS -D__STDC_LIMIT_MACROS")
set(LLVM_BINARY_DIR "/projects/vle/llvm-project/build")
set(LLVM_CMAKE_DIR "/projects/vle/llvm-project/llvm/cmake/modules")
set(LLVM_TOOLS_BINARY_DIR "/projects/vle/llvm-project/build/./bin")
set(LLVM_HAVE_OPT_VIEWER_MODULES 1)
set(LLVM_CONFIGURATION_TYPES )
set(LLVM_ENABLE_SHARED_LIBS OFF)

set(LLVM_DEFAULT_EXTERNAL_LIT "/projects/vle/llvm-project/build/./bin/llvm-lit")
set(LLVM_LIT_ARGS "-sv")

if(NOT TARGET LLVMSupport)
  include("/projects/vle/llvm-project/build/./lib/cmake/llvm/LLVMExports.cmake")
  include("/projects/vle/llvm-project/build/./lib/cmake/llvm/LLVMBuildTreeOnlyTargets.cmake")
endif()
